<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"/www/html/wx_oil/public/../application/oilcard/view/index/binding.html";i:1491967968;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="main">
        ...
        <div class="c_hao">
                ...
                <input  class="c_items2" type="text" placeholder="请输入真实姓名">
        </div>
        <!--立即绑定-->
