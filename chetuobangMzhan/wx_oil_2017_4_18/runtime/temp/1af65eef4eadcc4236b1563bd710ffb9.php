<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"/www/html/wx_oil/public/../application/oilbeanlotteryactivity/view/index/oilBeanL.html";i:1492052251;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="main">
    ...
    <div class="buy">
        ...
        <div class="today_gas_price">
            <span id="price_yuan"><?php echo $todayOilPrice['0']; ?></span>
            <span class="d">.</span>
            <span id="price_jiaofen"><?php echo $todayOilPrice['1']; ?></span>
        </div>
        <a href="javascript:;" class="card_zsh"></a>
        <a href="javascript:;" class="card_zsy"></a>
    </div>
</div>
</body>
</html>